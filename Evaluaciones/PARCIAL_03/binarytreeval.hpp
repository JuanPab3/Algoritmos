...
private:
  ...
  void insert_node(BSTNode<keyType,valType>* &node, BSTNode<keyType,valType> *p, keyType k, valType v);
  void display_node(BSTNode<keyType,valType> *node, int count);
  void destroy_recursive(BSTNode<keyType,valType>* node);
  BSTNode<keyType,valType>* find_node(BSTNode<keyType,valType>* node, keyType k);
  ...
  BSTNode<keyType,valType>* remove_node(BSTNode<keyType,valType>* &node, keyType k);
...
valType BST<keyType,valType>::get(keyType k) {
    ...
    BSTNode<keyType,valType>* temp = find(k);
    if (temp == nullptr) {
